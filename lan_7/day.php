...
<script src="js/custom_16052017.js"></script>
...
<body>
	<div id="page">
		...
		<section class="banner">
			<img src="images/lan_7/day.jpg" class="img-responsive" />
			<figure class="cloud"></figure>
		</section>

        <section class="para" id="para" style="padding-top: 71px;">
        	<div class="row">
            	<div class="container">
                	<div class="col-md-12">
                        <h2>
                    ...
                    <div class="col-md-12">
                    	<div class="content">
    						<p>
    							<b>Hội nghị:</b></br>
    							<p>Giới thiệu và thảo luận về các ứng dụng mới trên nền công nghệ điện toán đám mây. Đặc biệt năm 2017 sẽ tập trung đến chủ đề: “Siêu năng lực tính toán trong Cách mạng công nghiệp 4.0” nhằm giải quyết bài toán giao thông, an ninh công cộng, và các ứng dụng cần sự tính toán lớn như render phim ảnh, encoding và tính toán dữ liệu lớn.</p>
    						</p>
                            <p>
    							<b>Gian hàng triển lãm:</b> </br>
    							<p>Với hơn 30 gian hàng triển lãm từ các doanh nghiệp lớn về viễn thông, hạ tầng, hosting, ứng dụng, thiết bị, … Khách tham gia sẽ được tiếp cận và trải nghiệm các sản phẩm, dịch vụ cũng như ứng dụng mới nhất trong kĩnh vực CNTT. Ngoài ra, tại triển lãm sẽ có rất nhiều các chương trình ưu đãi hấp dẫn từ các doanh nghiệp.</p>
    						</p>
                            <p>
    							<b>Ngày hội Startup:</b> </br>
    							<p>Nơi hội ngộ giữa các nhà đầu tư/ Doanh nghiệp lớn với đông đảo với Startup trên cả nước, là nơi gặp gỡ của nhiều ý tưởng và sản phẩm mới lạ, gồm có:</p>
                                <ul>
                                    <li>•	Talkshow giữa các nhà đầu tư và Startup</li>
                                    <li>•	Thi phản biện của các Startup với hội đồng chấm thi Cloud8</li>
                                </ul>
                            </p>
                            <p>
    							<b>Đấu giá từ thiện:</b> </br>
    							<p>Ngoài cơ hội sở hữu các sản phẩm công nghệ với giá ưu đãi đặc biệt chỉ từ 0 đồng, chương trình đấu giá còn là hoạt động từ thiện thiết thực mang nhiều ý nghĩa cho cộng đồng và xã hội.</p>
    						</p>
                    	</div>
                    </div>
    			</div>
				...
				<div class="row">
					<center>
						...
						<!-- <div class="col-md-6" style="margin-top: 20px;">
							<a href="file/Congty_eDoctor_BacSiTrucTuyen.pdf" download><div class="fa fa-cloud-download" style="font-size: 20px;float: left;">&nbsp;eDoctor_BacSiTrucTuyen.pdf</div> </a>
						</div>
						<div class="col-md-6" style="margin-top: 20px;">
							<a href="file/Congty_iZiSell_BanHangTrucTuyen.pdf" download><div class="fa fa-cloud-download" style="font-size: 20px;float: left;">&nbsp;iZiSell_BanHangTrucTuyen.pdf</div> </a>
						</div>
						<div class="col-md-6" style="margin-top: 20px;">
							<a href="file/Congty_mPOS_ThanhToanTrucTuyen.pdf" download><div class="fa fa-cloud-download" style="font-size: 20px;float: left;">&nbsp;mPOS_ThanhToanTrucTuyen.pdf</div> </a>
						</div> -->
					</center>
				</div>
			</div>
...
// 			}
		...
		<section class="sponsor">
			<div class="row">
				<div class="container">
					<div class="col-md-12">
						<h2>
							Nhà Tài Trợ <span style="margin-bottom: 0;">SPONSOR</span> <a
								href="sponsors.php" style="color: #ff8000; font-size: 15px;">Xem
								chi tiết</a> <img src="images/line.png" alt="">
						</h2>
					</div>
					<div class="col-md-12">
						<a href="sponsors.php">
		...
		<nav id="menu-responsive">
			<ul>
				<li><a href="" title="" class="trans-hover">Day </a>
					<ul>
                        <li><a href="http://cloud8.hostingday.vn/lan_7/day.php" title=""><i
								class="fa fa-caret-right"></i>Cloud 8 Lần 7</a></li>
						<li><a href="http://cloud8.hostingday.vn/lan_6/day.html" title=""><i
								class="fa fa-caret-right"></i>Cloud 8 Lần 6</a></li>
						<li><a href="http://cloud8.hostingday.vn/lan_5" title=""><i
								class="fa fa-caret-right"></i>Cloud 8 Lần 5</a></li>
						<li><a href="http://cloud8.hostingday.vn/lan_4" title=""><i
								class="fa fa-caret-right"></i>Cloud 8 Lần 4</a></li>
				...
				<li><a href="http://cloud8.hostingday.vn/workshop/" title=""
					class="trans-hover">Workshop</a></li>
				<li><a href="" title="" class="trans-hover"><img
						src="images/logo-left-2017.png" alt="" /></a>
					<ul>
						<li><a href="#intro" title="" class="active">Chương trình - Home
								page</a></li>
	...
	<div id="popup" class="zoom-anim-dialog mfp-hide">
		<iframe frameborder="0" width="600" height="600"
			style="max-width: 100%; text-align: center;" align="center"
			src="https://ticketbox.vn/ticket-booking/61146/widget"></iframe>
	</div>
