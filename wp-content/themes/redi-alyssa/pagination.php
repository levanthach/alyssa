...
<script type="text/javascript">
	jQuery(function($){
		...
		var link_pageni = p.current_page;
		...
		prepend_pagi = '<li><a class="page-numbers" href="'+link_pageni_new_prev+'"><i class="fa fa-angle-double-left" aria-hidden="true"></i></a></li>';
		...
		append_pagi = '<li><a class="page-numbers" href="'+link_pageni_new_next+'"><i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>';
