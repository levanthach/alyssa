jQuery(function($){
	...
	var layoutRender = {
		...
		project2SliderPC:function(){
			
		    var owl_project_pc = $("#owl-project2");      

	       	owl_project_pc.owlCarousel({
	            responsiveClass:true,
	            margin:0,
	            loop:true,    
	            dots:false,
		      ...
		      owl_project_pc.on('mouseover',function(e){
		          owl_project_pc.trigger('stop.owl.autoplay');
		      })
		      owl_project_pc.on('mouseleave',function(e){
		           owl_project_pc.trigger('play.owl.autoplay');
		      })


		      $(".p2next").on('click', function () {
		         owl_project_pc.trigger('prev.owl.carousel');
		      });

		      $(".p2prev").on('click', function () {
		         owl_project_pc.trigger('next.owl.carousel');
		      });

		},
		project3SliderPC:function(){
			
		    var owl_project3_pc = $("#owl-project3");      

	       	owl_project3_pc.owlCarousel({
	            responsiveClass:true,
	            margin:0,
	            loop:true,    
	            dots:false,
		      ...
		      owl_project3_pc.on('mouseover',function(e){
		          owl_project3_pc.trigger('stop.owl.autoplay');
		      })
		      owl_project3_pc.on('mouseleave',function(e){
		           owl_project3_pc.trigger('play.owl.autoplay');
		      })


		      $(".p3next").on('click', function () {
		         owl_project3_pc.trigger('prev.owl.carousel');
		      });

		      $(".p3prev").on('click', function () {
		         owl_project3_pc.trigger('next.owl.carousel');
		      });

		},
		project2SliderMobile:function(){
			
		    var owl_project2_mobile = $("#owl-project2-mobile");      

	       	owl_project2_mobile.owlCarousel({
	            responsiveClass:true,
	            margin:20,
	            loop:true,    
	            dots:true,
		      ...
		      owl_project2_mobile.on('mouseover',function(e){
		          owl_project2_mobile.trigger('stop.owl.autoplay');
		      })
		      owl_project2_mobile.on('mouseleave',function(e){
		           owl_project2_mobile.trigger('play.owl.autoplay');
		      })


		      $(".p2m_next").on('click', function () {
		         owl_project2_mobile.trigger('prev.owl.carousel');
		      });

		      $(".p2m_prev").on('click', function () {
		         owl_project2_mobile.trigger('next.owl.carousel');
		      });

		},
		project3SliderMobile:function(){
			
		    var owl_project3_mobile = $("#owl-project3-mobile");      

	       	owl_project3_mobile.owlCarousel({
	            responsiveClass:true,
	            margin:20,
	            loop:true,    
	            dots:true,
		      ...
		      owl_project3_mobile.on('mouseover',function(e){
		          owl_project3_mobile.trigger('stop.owl.autoplay');
		      })
		      owl_project3_mobile.on('mouseleave',function(e){
		           owl_project3_mobile.trigger('play.owl.autoplay');
		      })


		      $(".p3m_next").on('click', function () {
		         owl_project3_mobile.trigger('prev.owl.carousel');
		      });

		      $(".p3m_prev").on('click', function () {
		         owl_project3_mobile.trigger('next.owl.carousel');
		      });
		...
		clientSliderFooter:function(){
		    ...
		    var owl_client = $("#owl-client");      
		      ...
		      owl_client.on('mouseover',function(e){
		          owl_client.trigger('stop.owl.autoplay');
		      })
		      owl_client.on('mouseleave',function(e){
		           owl_client.trigger('play.owl.autoplay');
		      })


		      $(".btn-prev.btn-control-client").on('click', function () {
		         owl_client.trigger('prev.owl.carousel');
		      });

		      $(".btn-next.btn-control-client").on('click', function () {
		...
		lightBoxgallery:function(){
			var $gallery = $('.box-p-detail a').simpleLightbox();
		...
		maxheight:function(){
			...
			$('.post-vertical-max-height').matchHeight(false);		
